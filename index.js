...
function clearContent() {
    ...
    textarea.va = '';
    outDiv.innerHTML = '';
    swal("Cleared", "The content has been cleared.", "success");
...
function toggleNightMode(button) {
    ...
    const image = document.getElementById('nightimage');
    const text = document.getElementById('nightbutton');
    if (image.src.includes("assets/icon-dark-mode.svg")){
        image.src = "assets/icon-light-mode.svg";
        text.textContent = 'LIGHT MODE';
    } else {
        image.src = "assets/icon-dark-mode.svg"; 
